...
const Upload = () => {
    ...
    const [nameMusic, setNameMusic] = useState(`Original sound - ${currentUser?.nickname}`);
    const imgRef = useRef();
                ...
                <div className={cx('modal-discard')}>
                    <div className={cx('modal-container')}>
                        <header>
                            ...
                            <div className={cx('desc-modal')}>Video và tất cả chỉnh sửa sẽ bị hủy bỏ.</div>
                        </header>
                        <Button
                            onClick={() => {
            ...
            {!!file ? (
                            ...
                            <div className={cx('video-card')}>
                                ...
                                <div className={cx('upload-video-info')}>
                                    ...
                                    <div className={cx('time-video')}>
                                        <span>00:00</span>
                                        <span>{duration}</span>
                                        <span>{duration.substring(1, 2) + `m` + duration.substring(3, 5) + 's'}</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className={cx('details')}>
                            ...
                            <div className={cx('details-container')}>
                                <div className={cx('video-frame')}>
                                    <div onClick={handleTogglePlay} className={cx('mobile-frame')}>
                                        <img
                                        ...
                                        <div className={cx('info-user')}>
                                            <div className={cx('nick-name')}>{currentUser.nickname}</div>
                                        ...
                                        <div className={cx('video-preview')}>
                                            <video ref={videoRefMobile} src={srcVideo} muted={muted} loop />
                                        </div>
                                            ...
                                            <div className={cx('controls-container')}>
                                                <div className={cx('controls-content')}>
                                                    <div className={cx('controls')}>
                                                        <div onClick={handleTogglePlay} className={cx('play-btn')}>
                                                            {play ? (
                                                        ...
                                                        <div className={cx('control-time-video')}>
                                                            ...
                                                            <div>/</div>
                                                            <div className={cx('duration-video')}>{duration}</div>
                                                        </div>
                                                    </div>
                                                    <div onClick={handleToggleMuted} className={cx('volume-video')}>
                                                        {muted ? (
                                ...
                                <div className={cx('submit-form')}>
                                    ...
                                    <div className={cx('caption-content')}>
                                        <input
                                            spellCheck={false}
                                            onChange={(e) => {
                                                isCaption ? setNameFile(e.target.value) : setNameMusic(e.target.value);
                                            }}
                                            className={cx('caption-name')}
                                            type="text"
                                            value={isCaption ? nameFile : nameMusic}
                                        />
                                        <div onClick={() => setIsCaption(!isCaption)} className={cx('img-music')}>
                                            {isCaption ? (
                                                dark ? (
                                                    <img src={svg.musicLight} alt="icon" />
                                                ) : (
                                                ...
                                                <FontAwesomeIcon fill="currenColor" icon={faPenToSquare} />
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className={cx('cover')}>
                                        ...
                                        <div className={cx('thumb-img')}>
                                            <div className={cx('thumb-container')}>
                                                ...
                                                />
                                                <div
                                                    style={{ left: leftValue > 0 ? `${leftValue}%` : null }}
                                    ...
                                    <div className={cx('permissions')}>
                                        <span className={cx('select-title')}>{t('Who can watch this video')}</span>
                                        <div onClick={(e) => e.stopPropagation()} className={cx('selected')}>
                                            <div
                                                onClick={() => {
                                            ...
                                            >
                                                ...
                                                <div className={cx('select-icon')}>
                                                    <svg
                                                        style={{ transform: isSelect ? 'rotate(180deg)' : null }}
                                                        width="1em"
                                                        height="1em"
                                                        viewBox="0 0 48 48"
                                                        fill="currentColor"
                                        ...
                                        <span className={cx('checkbox-title')}>{t('Allow users to:')}</span>
                                        <div className={cx('check-box')}>
                                            <div className={cx('check-box-content')}>
                                                <div className={cx('check-box-item')}>
                                                    <div
                                                        style={{
                                                            backgroundColor: stateCheck.comment ? null : 'transparent',
                                                        }}
                                            ...
                                            <div className={cx('check-box-content')}>
                                                <div className={cx('check-box-item')}>
                                                    <div
                                                        style={{
                                                            backgroundColor: stateCheck.duet ? null : 'transparent',
                                                        }}
                                                        className={cx('check-item')}
                                                    >
                                                        <svg
                                            ...
                                            <div className={cx('check-box-content')}>
                                                <div className={cx('check-box-item')}>
                                                    <div
                                                        style={{
                                                            backgroundColor: stateCheck.stitch ? null : 'transparent',
                                                        }}
                                                        className={cx('check-item')}
                                                    >
                                                        <svg
                ...
                <div className={cx('container')}>
                    ...
                    <label htmlFor="input-file" className={cx('content')}>
                        {dark ? <img src={svg.uploadLight} alt="icon" /> : <img src={svg.upload} alt="icon" />}
                        <span className={cx('title')}>{t('Select video to upload')}</span>
                        <span className={cx('info')}>{t('Or drag and drop a file')}</span>
                        <span className={cx('info')}>
                            {t('Long videos can be split into multiple parts to get more exposure')}
                        </span>
