...
const ProfileContent = ({mount,setMount, data, followed, dataVideo }) => {
    ...
    const currentUser = useSelector((state) => state.auth.currentUser.data?.nickname);
            ...
            <header className={cx('user-info')}>
                <div className={cx('account-info')}>
                    ...
                    <div>
                        ...
                        <h1 className={cx('full-name')}>{`${data.first_name + ' ' + data.last_name}`}</h1>
                        <div className={cx('interact-btn')}>
                            {currentUser === nickname ? (
                                <button onClick={() => setUpdate(true)} className={cx('update-profile')}>
            ...
            <div className={cx('video-profile')}>
                <div className={cx('tab-list')}>
                    ...
                    <div
                        ...
                        className={cx('tab-item')}
                    >
                        {dark ? <img src={svg.lockLight} alt="icon" /> : <img src={svg.lock} alt="icon" />}
                        <span>{t('Liked')}</span>
                    </div>
                ...
                <div className={cx('video-container')}>
                    {active ? (
                        dataVideo?.map((item, idx) => {
                            return <VideoProfile index={index} setIndex={setIndex} idx={idx} data={item} key={idx} />;
                        })
                    ) : (
                        ...
                        <div className={cx('body')}>
                            ...
                            <div className={cx('edit-photo')}>
                                ...
                                <div className={cx('input-user')}>
                                    ...
                                    <p className={cx('tip')}>Nhập họ của bạn (độ dài lớn hơn 2 ký tự)</p>
                                </div>
                            </div>
                            <div className={cx('edit-photo')}>
                                ...
                                <div className={cx('input-user')}>
                                    <input
                                        ...
                                        value={lastName}
                                    />
                                    <p className={cx('tip')}>Nhập tên của bạn(độ dài lớn hơn 2 ký tự)</p>
                                </div>
                            </div>
                            <div style={{ border: 'none' }} className={cx('edit-photo')}>
                                ...
                                <textarea
                                    ...
                                    spellCheck={false}
                                />
                                <p style={{ marginLeft: '10px' }} className={cx('tip')}>{`${countInp}/80`}</p>
                            </div>
                        </div>
